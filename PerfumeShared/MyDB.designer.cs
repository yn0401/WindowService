...
namespace PerfumeShared
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="yeensnhi_mydb")]
    ...
    partial void InsertPerfume(Perfume instance);
    partial void UpdatePerfume(Perfume instance);
    partial void DeletePerfume(Perfume instance);
    #endregion
		
		public MyDBDataContext() : 
				base(global::PerfumeShared.Properties.Settings.Default.yeensnhi_mydbConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<Perfume> Perfumes
		{
			get
			{
				return this.GetTable<Perfume>();
			}
		}
	}

    [Serializable]
    [global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Perfume")]
	public partial class Perfume : INotifyPropertyChanging, INotifyPropertyChanged
	{
